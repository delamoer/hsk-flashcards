const e="hsk",t=2,n=[{num:1,name:"九月去北京旅游最好",texts:[{n:1,title:"课文1",original:`A：我想去北京旅游，你觉得什么时候去最好？
B：九月去北京旅游最好。
A：为什么？
B：九月的北京天气不冷也不热。`,lines:[{name:"A",zh:"我想去北京旅游，你觉得什么时候去最好？",py:"Wǒ xiǎng qù Běijīng lǚyóu, nǐ juéde shénme shíhou qù zuì hǎo?",en:"I want to travel to Beijing—when do you think is the best time to go?"},{name:"B",zh:"九月去北京旅游最好。",py:"Jiǔ yuè qù Běijīng lǚyóu zuì hǎo.",en:"September is the best time to travel to Beijing."},{name:"A",zh:"为什么？",py:"Wèishénme?",en:"Why?"},{name:"B",zh:"九月的北京天气不冷也不热。",py:"Jiǔ yuè de Běijīng tiānqì bù lěng yě bú rè.",en:"In September, Beijing's weather is neither cold nor hot."}],vocab:{seg:[{t:"A：我想去北京"},{b:1},{t:"，你"},{b:2},{t:"什么时候去"},{b:3},{t:`好？
B：九月去北京旅游最好。
A：为什么？
B：九月的北京天气不冷`},{b:4},{t:"不热。"}],answers:["旅游","觉得","最","也"]},grammar:{before:"A：我想去北京旅游，你觉得",after:`？
B：九月去北京旅游最好。
A：为什么？
B：九月的北京天气不冷也不热。`,answer:"什么时候去最好",tokens:["什么","时候","去","最好"]},sentences:[{speaker:"A",text:"我想去北京旅游，你觉得什么时候去最好？",tokens:["我","想","去","北京","旅游","你","觉得","什么","时候","去","最好"]},{speaker:"B",text:"九月去北京旅游最好。",tokens:["九","月","去","北京","旅游","最好"]},{speaker:"B",text:"九月的北京天气不冷也不热。",tokens:["九","月","的","北京","天气","不","冷","也","不","热"]}],note:"助动词“要”；程度副词“最”；概数的表达：“几”“多”"},{n:2,title:"课文2",original:`A：你喜欢什么运动？
B：我最喜欢踢足球。
A：下午我们一起去踢足球吧。
B：好啊！`,lines:[{name:"A",zh:"你喜欢什么运动？",py:"Nǐ xǐhuan shénme yùndòng?",en:"What sports do you like?"},{name:"B",zh:"我最喜欢踢足球。",py:"Wǒ zuì xǐhuan tī zúqiú.",en:"I like playing soccer the most."},{name:"A",zh:"下午我们一起去踢足球吧。",py:"Xiàwǔ wǒmen yìqǐ qù tī zúqiú ba.",en:"Let's go play soccer together this afternoon."},{name:"B",zh:"好啊！",py:"Hǎo a!",en:"Sure!"}],vocab:{seg:[{t:"A：你喜欢什么"},{b:1},{t:`？
B：我`},{b:2},{t:"喜欢"},{b:3},{t:`。
A：下午我们一起去踢足球吧。
B：好啊！`}],answers:["运动","最","踢足球"]},grammar:{before:`A：你喜欢什么运动？
B：我`,after:`喜欢踢足球。
A：下午我们一起去踢足球吧。
B：好啊！`,answer:"最",tokens:["最"]},sentences:[{speaker:"A",text:"你喜欢什么运动？",tokens:["你","喜欢","什么","运动"]},{speaker:"B",text:"我最喜欢踢足球。",tokens:["我","最","喜欢","踢足球"]},{speaker:"A",text:"下午我们一起去踢足球吧。",tokens:["下午","我们","一起","去","踢足球","吧"]},{speaker:"B",text:"好啊！",tokens:["好","啊"]}],note:"助动词“要”；程度副词“最”；概数的表达：“几”“多”"},{n:3,title:"课文3",original:`A：我们要不要买几个新的椅子？
B：好啊。什么时候去买？
A：明天下午怎么样？你明天几点能回来？
B：三点多。`,lines:[{name:"A",zh:"我们要不要买几个新的椅子？",py:"Wǒmen yào bu yào mǎi jǐ ge xīn de yǐzi?",en:"Should we buy a few new chairs?"},{name:"B",zh:"好啊。什么时候去买？",py:"Hǎo a. Shénme shíhou qù mǎi?",en:"Sure. When should we go buy them?"},{name:"A",zh:"明天下午怎么样？你明天几点能回来？",py:"Míngtiān xiàwǔ zěnmeyàng? Nǐ míngtiān jǐ diǎn néng huílai?",en:"How about tomorrow afternoon? What time can you be back tomorrow?"},{name:"B",zh:"三点多。",py:"Sān diǎn duō.",en:"A little after three."}],vocab:{seg:[{t:"A：我们"},{b:1},{t:"不要买几个"},{b:2},{t:`的椅子？
B：好啊。什么时候去买？
A：明天下午怎么样？你明天几点能回来？
B：三点多。`}],answers:["要","新"]},grammar:{before:"A：我们",after:`买几个新的椅子？
B：好啊。什么时候去买？
A：明天下午怎么样？你明天几点能回来？
...
B：是啊，我觉得它的眼睛最漂亮。
A：它多大了？
B：六个多月。`,lines:[{name:"A",zh:"桌子下面有个猫。",py:"Zhuōzi xiàmiàn yǒu ge māo.",en:"There's a cat under the table."},{name:"B",zh:"那是我的猫，它叫花花。",py:"Nà shì wǒ de māo, tā jiào Huāhua.",en:"That's my cat; its name is Huahua."},{name:"A",zh:"它很漂亮。",py:"Tā hěn piàoliang.",en:"It's pretty."},{name:"B",zh:"是啊，我觉得它的眼睛最漂亮。",py:"Shì a, wǒ juéde tā de yǎnjing zuì piàoliang.",en:"Yeah, I think its eyes are the prettiest."},{name:"A",zh:"它多大了？",py:"Tā duō dà le?",en:"How old is it?"},{name:"B",zh:"六个多月。",py:"Liù ge duō yuè.",en:"A little over six months."}],vocab:{seg:[{t:`A：桌子下面有个猫。
B：那是我的猫，`},{b:1},{t:`叫花花。
A：它很漂亮。
B：是啊，我觉得它的`},{b:2},{t:`最漂亮。
A：它`},{b:3},{t:`大了？
B：六个多月。`}],answers:["它","眼睛","多"]},grammar:{before:`A：桌子下面有个猫。
B：那是我的猫，它叫花花。
A：它很漂亮。
B：是啊，我觉得它的眼睛最漂亮。
A：它多大了？
...
B：是啊，我`},{b:2},{b:3},{t:"都要出去"},{b:4},{t:`。
A：你每天几点`},{b:5},{t:`？
B：我每天六点起床。`}],answers:["生病","每天","早上","跑步","起床"]},grammar:{before:"A：你很少生病，",after:`？
B：是啊，我每天早上都要出去跑步。
A：你每天几点起床？
B：我每天六点起床。`,answer:"是不是喜欢运动",tokens:["是不是","喜欢","运动"]},sentences:[{speaker:"A",text:"你很少生病，是不是喜欢运动？",tokens:["你","很","少","生病","是不是","喜欢","运动"]},{speaker:"B",text:"是啊，我每天早上都要出去跑步。",tokens:["是","啊","我","每天","早上","都","要","出去","跑步"]},{speaker:"A",text:"你每天几点起床？",tokens:["你","每天","几","点","起床"]},{speaker:"B",text:"我每天六点起床。",tokens:["我","每天","六","点","起床"]}],note:"用“是不是”的问句；代词“每”；疑问代词“多”"},{n:2,title:"课文2",original:`A：吃药了吗？现在身体怎么样？
B：吃了。现在好多了。
A：什么时候能出院？
B：医生说下个星期。`,lines:[{name:"A",zh:"吃药了吗？现在身体怎么样？",py:"Chī yào le ma? Xiànzài shēntǐ zěnmeyàng?",en:"Have you taken your medicine? How do you feel now?"},{name:"B",zh:"吃了。现在好多了。",py:"Chī le. Xiànzài hǎo duō le.",en:"I have. I'm much better now."},{name:"A",zh:"什么时候能出院？",py:"Shénme shíhou néng chūyuàn?",en:"When can you be discharged?"},{name:"B",zh:"医生说下个星期。",py:"Yīshēng shuō xià ge xīngqī.",en:"The doctor says next week."}],vocab:{seg:[{t:"A：吃"},{b:1},{t:"了吗？现在"},{b:2},{t:`怎么样？
B：吃了。现在好多了。
A：什么时候能`},{b:3},{t:`？
B：医生说下个星期。`}],answers:["药","身体","出院"]},grammar:{before:"A：吃药了吗？",after:`？
B：吃了。现在好多了。
A：什么时候能出院？
...
B：一米八几。
A：你怎么知道这么多啊？
B：他是我同学。`,lines:[{name:"A",zh:"大卫今年多大？",py:"Dàwèi jīnnián duō dà?",en:"How old is David this year?"},{name:"B",zh:"二十多岁。",py:"Èrshí duō suì.",en:"In his twenties."},{name:"A",zh:"他多高？",py:"Tā duō gāo?",en:"How tall is he?"},{name:"B",zh:"一米八几。",py:"Yì mǐ bā jǐ.",en:"One meter eighty-something."},{name:"A",zh:"你怎么知道这么多啊？",py:"Nǐ zěnme zhīdào zhème duō a?",en:"How do you know so much?"},{name:"B",zh:"他是我同学。",py:"Tā shì wǒ tóngxué.",en:"He's my classmate."}],vocab:{seg:[{t:`A：大卫今年多大？
B：二十多岁。
A：他多`},{b:1},{t:`？
B：一`},{b:2},{t:`八几。
A：你怎么`},{b:3},{t:`这么多啊？
B：他是我同学。`}],answers:["高","米","知道"]},grammar:{before:"A：大卫今年",after:`？
B：二十多岁。
A：他多高？
B：一米八几。
A：你怎么知道这么多啊？
...
B：是啊，他这几天很`},{b:2},{t:"，没有"},{b:3},{t:`休息。
A：那会很累吧？
B：他每天回来都很累。`}],answers:["休息","忙","时间"]},grammar:{before:`A：张老师星期六也不休息啊？
B：是啊，他这几天很忙，没有时间休息。
A：那会很累吧？
B：他`,after:"回来都很累。",answer:"每天",tokens:["每天"]},sentences:[{speaker:"A",text:"张老师星期六也不休息啊？",tokens:["张","老师","星期","六","也","不","休息","啊"]},{speaker:"B",text:"是啊，他这几天很忙，没有时间休息。",tokens:["是","啊","他","这","几天","很","忙","没有","时间","休息"]},{speaker:"A",text:"那会很累吧？",tokens:["那","会","很","累","吧"]},{speaker:"B",text:"他每天回来都很累。",tokens:["他","每天","回来","都","很","累"]}],note:"用“是不是”的问句；代词“每”；疑问代词“多”"}]},{num:3,name:"左边那个红色的是我的",texts:[{n:1,title:"课文1",original:`A：这块手表是你的吗？
B：不是我的，是我爸爸的。
A：多少钱买的？
B：三千多块。`,lines:[{name:"A",zh:"这块手表是你的吗？",py:"Zhè kuài shǒubiǎo shì nǐ de ma?",en:"Is this watch yours?"},{name:"B",zh:"不是我的，是我爸爸的。",py:"Bú shì wǒ de, shì wǒ bàba de.",en:"It's not mine; it's my dad's."},{name:"A",zh:"多少钱买的？",py:"Duōshao qián mǎi de?",en:"How much did it cost?"},{name:"B",zh:"三千多块。",py:"Sānqiān duō kuài.",en:"Over three thousand yuan."}],vocab:{seg:[{t:"A：这块"},{b:1},{t:`是你的吗？
B：不是我的，是我爸爸的。
A：多少钱买的？
B：三`},{b:2},{t:"多块。"}],answers:["手表","千"]},grammar:{before:`A：这块手表是你的吗？
B：不是我的，是`,after:`。
A：多少钱买的？
...
B：不是，是昨天的。
A：你听，是不是`},{b:2},{t:`报纸的来了？
B：我看`},{b:3},{t:"。不是，是送"},{b:4},{t:"的。"}],answers:["报纸","送","一下","牛奶"]},grammar:{before:`A：这是今天早上的报纸吗？
B：不是，是昨天的。
A：你听，是不是送报纸的来了？
...
B：这是我和我`},{b:2},{t:"的，"},{b:3},{t:`那个小的房间是我女儿的。
A：你女儿的房间真漂亮！都是`},{b:4},{t:`的。
B：是啊，粉色是我女儿最喜欢的`},{b:5},{t:"。"}],answers:["房间","丈夫","旁边","粉色","颜色"]},grammar:{before:`A：这是谁的房间？
B：这是我和我丈夫的，旁边那个小的房间是我女儿的。
...
B：这里有几个杯子，哪个是你的？
A：`},{b:1},{t:"那个"},{b:2},{t:`的是我的。
B：给你。`}],answers:["左边","红色"]},grammar:{before:`A：你看见我的杯子了吗？
B：这里有几个杯子，哪个是你的？
A：`,after:`是我的。
...
B：是什么？是一本书吗？
A：对，这本书是我写的。
B：太谢谢你了！`}],answers:["生日","快乐","给"]},grammar:{before:`A：生日快乐！这是送给你的！
B：是什么？是一本书吗？
A：对，`,after:`。
...
B：电话是谁打的？
A：不知道，是儿子`},{b:1},{t:`的。
B：好，`},{b:2},{t:"我"},{b:3},{t:"一下儿子。"}],answers:["接","晚上","问"]},grammar:{before:`A：早上有你一个电话。
B：电话是谁打的？
A：不知道，`,after:`。
...
B：`},{b:1},{t:`喜欢。
A：你是什么时候`},{b:2},{t:`踢足球的？
B：我十一岁的时候开始踢足球，`},{b:3},{t:"踢了十年了。"}],answers:["非常","开始","已经"]},grammar:{before:`A：你喜欢踢足球吗？
B：非常喜欢。
A：你是什么时候开始踢足球的？
...
B：`},{b:1},{t:`两年多了，我是2011年来的。
A：你认识谢先生吗？
B：认识，我们是大学同学，这个工作是他`},{b:2},{t:"我"},{b:3},{t:"的。"}],answers:["已经","帮","介绍"]},grammar:{before:`A：你在这儿工作多长时间了？
B：`,after:`，我是2011年来的。
A：你认识谢先生吗？
...
B：我不想去`},{b:1},{t:`吃，我想在家吃。
A：那你`},{b:2},{t:`做什么呢？
B：就做你爱吃的`},{b:3},{t:"吧。"}],answers:["外面","准备","鱼"]},grammar:{before:`A：晚上我们去饭馆吃饭，怎么样？
B：我不想去外面吃，我想在家吃。
A：那你准备做什么呢？
...
B：颜色`},{b:2},{b:3},{t:`，就是有点儿大。
A：这件小的怎么样？
B：这件`},{b:4},{t:"，就买这件吧。"}],answers:["件","还","可以","不错"]},grammar:{before:`A：帮我看一下这件衣服怎么样？
B：颜色还可以，就是`,after:`。
A：这件小的怎么样？
B：这件不错，就买这件吧。`,answer:"有点儿大",tokens:["有点儿","大"]},sentences:[{speaker:"A",text:"帮我看一下这件衣服怎么样？",tokens:["帮","我","看","一下","这件","衣服","怎么样"]},{speaker:"B",text:"颜色还可以，就是有点儿大。",tokens:["颜色","还可以","就是","有点儿","大"]},{speaker:"A",text:"这件小的怎么样？",tokens:["这件","小","的","怎么样"]},{speaker:"B",text:"这件不错，就买这件吧。",tokens:["这件","不错","就","买","这件","吧"]}],note:"副词“就”；语气副词“还”（1）；程度副词“有点儿”"},{n:3,title:"课文3",original:`A：今天去不去打球？
B：这两天有点儿累，不去打球了。
A：你在做什么呢？是在想昨天的考试吗？
B：是啊，我觉得听和说还可以，读和写不好，很多字我都不知道是什么意思。`,lines:[{name:"A",zh:"今天去不去打球？",py:"Jīntiān qù bu qù dǎ qiú?",en:"Are we going to play ball today?"},{name:"B",zh:"这两天有点儿累，不去打球了。",py:"Zhè liǎng tiān yǒudiǎnr lèi, bú qù dǎ qiú le.",en:"I've been a bit tired these days; I won't go play ball."},{name:"A",zh:"你在做什么呢？是在想昨天的考试吗？",py:"Nǐ zài zuò shénme ne? Shì zài xiǎng zuótiān de kǎoshì ma?",en:"What are you doing? Thinking about yesterday's exam?"},{name:"B",zh:"是啊，我觉得听和说还可以，读和写不好，很多字我都不知道是什么意思。",py:"Shì a, wǒ juéde tīng hé shuō hái kěyǐ, dú hé xiě bù hǎo, hěn duō zì wǒ dōu bù zhīdào shì shénme yìsi.",en:"Yeah, I think my listening and speaking are okay, but reading and writing aren't good—I don't know what a lot of the characters mean."}],vocab:{seg:[{t:`A：今天去不去打球？
B：这两天有点儿累，不去打球了。
A：你在做什么呢？是在想昨天的`},{b:1},{t:`吗？
B：是啊，我觉得听和说`},{b:2},{t:"可以，读和写不好，很多字我都不知道是什么"},{b:3},{t:"。"}],answers:["考试","还","意思"]},grammar:{before:`A：今天去不去打球？
B：这两天有点儿累，不去打球了。
A：你在做什么呢？是在想昨天的考试吗？
...
B：不喝了，我已经喝两杯了。
A：是啊，咖啡喝多了`},{b:2},{t:`身体不好。
B：`},{b:3},{t:"我少喝一点儿，每天喝一杯。"}],answers:["咖啡","对","以后"]},grammar:{before:`A：休息一下吧，喝咖啡吗？
B：不喝了，我已经喝两杯了。
A：是啊，咖啡喝多了对身体不好。
...
B：他已经来了。
A：你怎么知道他来了？
B：我在`},{b:1},{t:"看见他的"},{b:2},{t:"了。"}],answers:["门外","自行车"]},grammar:{before:`A：你知道小王今天什么时候来学校吗？
B：他已经来了。
A：`,after:`？
...
B：这个星期天天都吃羊肉，不想吃了。
A：那你还想吃什么？
B：来一点儿`},{b:3},{t:"吧。"}],answers:["羊肉","好吃","面条"]},grammar:{before:`A：今天的羊肉很好吃，你怎么不吃了？
...
B：因为昨天下雨，所以我们都没去。我去`},{b:2},{t:`了。
A：你`},{b:3},{t:`游泳吗？
B：这个月我天天游泳，我现在七十`},{b:4},{t:"了。"}],answers:["打篮球","游泳","经常","公斤"]},grammar:{before:`A：昨天你们怎么都没去打篮球？
B：`,after:`。我去游泳了。
A：你经常游泳吗？
...
B：他去北京了。
A：去北京了？是去旅游吗？
B：不是，听说是去看他`},{b:1},{t:"。"}],answers:["姐姐"]},grammar:{before:"A：",after:`？
B：他去北京了。
A：去北京了？是去旅游吗？
...
B：没有，他还在`},{b:1},{t:`学习呢。
A：已经九点多了，他怎么还在学习？
B：明天有考试，他说今天要好好准备。`}],answers:["教室"]},grammar:{before:`A：大卫回来了吗？
B：没有，他`,after:`。
A：已经九点多了，他怎么还在学习？
...
B：在去`},{b:1},{t:"的"},{b:2},{t:"。你已经"},{b:3},{t:`了？
A：我下飞机了。你还有多长时间能到这儿？
B：二十分钟就到。`}],answers:["机场","路上","到"]},grammar:{before:`A：你现在在哪儿呢？
B：在去机场的路上。你已经到了？
A：我下飞机了。你还有多长时间能到这儿？
...
B：很远，坐`},{b:4},{t:"要一个多"},{b:5},{t:`呢！
A：坐公共汽车太`},{b:6},{t:`了，你怎么不开车？
B：开车也不快，路上车太多了！`}],answers:["离","公司","远","公共汽车","小时","慢"]},grammar:{before:"A：",after:`？
B：很远，坐公共汽车要一个多小时呢！
A：坐公共汽车太慢了，你怎么不开车？
B：开车也不快，路上车太多了！`,answer:"你家离公司远吗",tokens:["你家","离","公司","远","吗"]},sentences:[{speaker:"A",text:"你家离公司远吗？",tokens:["你家","离","公司","远","吗"]},{speaker:"B",text:"很远，坐公共汽车要一个多小时呢！",tokens:["很","远","坐","公共汽车","要","一个","多","小时","呢"]},{speaker:"A",text:"坐公共汽车太慢了，你怎么不开车？",tokens:["坐","公共汽车","太","慢","了","你","怎么","不","开车"]},{speaker:"B",text:"开车也不快，路上车太多了！",tokens:["开车","也","不","快","路上","车","太","多","了"]}],note:"语气副词“还”（2）；时间副词“就”；动词“离”；语气助词“呢”"},{n:4,title:"课文4",original:`A：今天晚上我们一起吃饭吧，给你过生日。
B：今天？离我的生日还有一个多星期呢！
A：下个星期我要去北京，今天过吧。
B：好吧，离这儿不远有一个中国饭馆，走几分钟就到了。`,lines:[{name:"A",zh:"今天晚上我们一起吃饭吧，给你过生日。",py:"Jīntiān wǎnshang wǒmen yìqǐ chī fàn ba, gěi nǐ guò shēngrì.",en:"Let's have dinner together tonight to celebrate your birthday."},{name:"B",zh:"今天？离我的生日还有一个多星期呢！",py:"Jīntiān? Lí wǒ de shēngrì hái yǒu yí ge duō xīngqī ne!",en:"Today? My birthday is still over a week away!"},{name:"A",zh:"下个星期我要去北京，今天过吧。",py:"Xià ge xīngqī wǒ yào qù Běijīng, jīntiān guò ba.",en:"I'm going to Beijing next week, so let's celebrate today."},{name:"B",zh:"好吧，离这儿不远有一个中国饭馆，走几分钟就到了。",py:"Hǎo ba, lí zhèr bù yuǎn yǒu yí ge Zhōngguó fànguǎn, zǒu jǐ fēnzhōng jiù dào le.",en:"All right, there's a Chinese restaurant not far from here—just a few minutes' walk."}],vocab:{seg:[{t:"A：今天晚上我们一起吃饭吧，给你"},{b:1},{t:`。
B：今天？离我的生日还有一个多星期呢！
A：下个星期我要去北京，今天过吧。
B：好吧，离这儿不远有一个中国饭馆，`},{b:2},{t:"几分钟就"},{b:3},{t:"了。"}],answers:["过生日","走","到"]},grammar:{before:`A：今天晚上我们一起吃饭吧，给你过生日。
B：今天？离我的生日还有一个多星期呢！
A：下个星期我要去北京，今天过吧。
...
B：今天下午我没有时间，明天下午`},{b:1},{t:`去吧。
A：你想看什么电影？
B：让我想想再`},{b:2},{t:"你。"}],answers:["再","告诉"]},grammar:{before:`A：我们下午去看电影，好吗？
B：今天下午我没有时间，`,after:`。
A：你想看什么电影？
...
B：你`},{b:1},{t:`等我，好吗？王老师让我给大卫打个电话。
A：回来再打吧。`},{b:2},{t:"大卫有什么"},{b:3},{t:`吗？
B：听说大卫病了，我想找时间去看看他。`}],answers:["等","找","事情"]},grammar:{before:`A：外边天气很好，我们出去运动运动吧。
B：你等等我，好吗？`,after:`。
A：回来再打吧。找大卫有什么事情吗？
...
B：您住哪个房间？
A：317。
B：好的，我叫人去看看。`}],answers:["服务员"]},grammar:{before:`A：服务员，我房间的门打不开了。
B：您住哪个房间？
A：317。
B：好的，`,after:"。",answer:"我叫人去看看",tokens:["我","叫","人","去","看看"]},sentences:[{speaker:"A",text:"服务员，我房间的门打不开了。",tokens:["服务员","我","房间","的","门","打","不","开","了"]},{speaker:"B",text:"您住哪个房间？",tokens:["您","住","哪个","房间"]},{speaker:"A",text:"317。",tokens:["3","1","7"]},{speaker:"B",text:"好的，我叫人去看看。",tokens:["好","的","我","叫","人","去","看看"]}],note:"疑问句“……，好吗？”；副词“再”；兼语句；动词重叠"},{n:4,title:"课文4",original:`A：你看看这几件衣服怎么样。
B：这件白的有点儿长，那件黑的有点儿贵。
A：这件红的呢？这是今天新来的。
B：让我再看看。`,lines:[{name:"A",zh:"你看看这几件衣服怎么样。",py:"Nǐ kànkan zhè jǐ jiàn yīfu zěnmeyàng.",en:"Take a look at these clothes and see what you think."},{name:"B",zh:"这件白的有点儿长，那件黑的有点儿贵。",py:"Zhè jiàn bái de yǒudiǎnr cháng, nà jiàn hēi de yǒudiǎnr guì.",en:"The white one is a bit long, and the black one is a bit expensive."},{name:"A",zh:"这件红的呢？这是今天新来的。",py:"Zhè jiàn hóng de ne? Zhè shì jīntiān xīn lái de.",en:"How about this red one? It just came in today."},{name:"B",zh:"让我再看看。",py:"Ràng wǒ zài kànkan.",en:"Let me have another look."}],vocab:{seg:[{t:`A：你看看这几件衣服怎么样。
B：这件`},{b:1},{t:"的有点儿长，那件"},{b:2},{t:"的有点儿"},{b:3},{t:`。
A：这件红的呢？这是今天新来的。
B：让我`},{b:4},{t:"看看。"}],answers:["白","黑","贵","再"]},grammar:{before:`A：你看看这几件衣服怎么样。
B：这件白的有点儿长，那件黑的有点儿贵。
A：这件红的呢？这是今天新来的。
...
A：对不起。`}],answers:["错"]},grammar:{before:`A：你好！请问张欢在吗？
...
B：我第一次跳舞是在七岁的时候。
A：我女儿今年也七岁了。我`},{b:3},{t:`她能跟您学跳舞，可以吗？
B：没问题，非常`},{b:4},{t:"。"}],answers:["从","跳舞","希望","欢迎"]},grammar:{before:"A：您",after:`学习跳舞？
B：我第一次跳舞是在七岁的时候。
A：我女儿今年也七岁了。我希望她能跟您学跳舞，可以吗？
...
B：太好了！他从什么时候开始`},{b:1},{t:`？
A：从下个星期一开始。
B：这是他的`},{b:2},{t:"个工作，"},{b:3},{t:"他能喜欢。"}],answers:["上班","第一","希望"]},grammar:{before:`A：你知道吗？大卫找到工作了。
B：太好了！他从什么时候开始上班？
A：从下个星期一开始。
...
B：听懂了。
A：你都做`},{b:2},{t:`了没有？
B：`},{b:3},{t:"太多，我没做完。"}],answers:["懂","完","题"]},grammar:{before:`A：昨天的考试怎么样？你都听懂了吗？
B：听懂了。
A：你都`,after:`了没有？
...
B：看电视对学汉语有`},{b:2},{t:`。
A：明天的课你都准备好了吗？
B：都准备好了。`}],answers:["课","帮助"]},grammar:{before:"A：",after:`，明天上午还有汉语课呢。
B：看电视对学汉语有帮助。
A：明天的课你都准备好了吗？
B：都准备好了。`,answer:"不要看电视了",tokens:["不要","看","电视","了"]},sentences:[{speaker:"A",text:"不要看电视了，明天上午还有汉语课呢。",tokens:["不要","看","电视","了","明天","上午","还有","汉语","课","呢"]},{speaker:"B",text:"看电视对学汉语有帮助。",tokens:["看","电视","对","学","汉语","有","帮助"]},{speaker:"A",text:"明天的课你都准备好了吗？",tokens:["明天","的","课","你","都","准备","好","了","吗"]},{speaker:"B",text:"都准备好了。",tokens:["都","准备","好","了"]}],note:"祈使句：不要……了；别……了；介词“对”"},{n:2,title:"课文2",original:`A：别看报纸了，医生说你要多休息。
B：好，不看了。给我一杯茶吧。
A：医生说吃药后两个小时不要喝茶。
B：医生还说什么了？
A：医生让你听我的。`,lines:[{name:"A",zh:"别看报纸了，医生说你要多休息。",py:"Bié kàn bàozhǐ le, yīshēng shuō nǐ yào duō xiūxi.",en:"Stop reading the newspaper—the doctor says you need more rest."},{name:"B",zh:"好，不看了。给我一杯茶吧。",py:"Hǎo, bú kàn le. Gěi wǒ yì bēi chá ba.",en:"Okay, I'll stop. Get me a cup of tea, please."},{name:"A",zh:"医生说吃药后两个小时不要喝茶。",py:"Yīshēng shuō chī yào hòu liǎng ge xiǎoshí bú yào hē chá.",en:"The doctor said not to drink tea for two hours after taking medicine."},{name:"B",zh:"医生还说什么了？",py:"Yīshēng hái shuō shénme le?",en:"What else did the doctor say?"},{name:"A",zh:"医生让你听我的。",py:"Yīshēng ràng nǐ tīng wǒ de.",en:"The doctor said you should listen to me."}],vocab:{seg:[{t:"A："},{b:1},{t:`看报纸了，医生说你要多休息。
B：好，不看了。给我一杯茶吧。
A：医生说吃药后两个小时不要喝茶。
B：医生还说什么了？
A：医生让你听我的。`}],answers:["别"]},grammar:{before:`A：别看报纸了，医生说你要多休息。
B：好，不看了。给我一杯茶吧。
A：医生说吃药后两个小时`,after:`。
B：医生还说什么了？
...
B：`},{b:1},{t:`今天中午回来吃饭。
A：我看看买什么了。羊肉、`},{b:2},{t:"、面条、"},{b:3},{t:`……真不少！妈妈呢？
B：`},{b:4},{t:"准备午饭呢！"}],answers:["哥哥","鸡蛋","西瓜","正在"]},grammar:{before:`A：你怎么买了这么多东西啊？
B：哥哥今天中午回来吃饭。
A：我看看买什么了。羊肉、鸡蛋、面条、西瓜……真不少！妈妈呢？
...
A：别找了，手机在桌子上呢，电脑旁边。
B：你看见我的衣服了吗？红色的那件。
A：那件衣服我帮你洗了，在外边呢。`,lines:[{name:"A",zh:"你在找什么？",py:"Nǐ zài zhǎo shénme?",en:"What are you looking for?"},{name:"B",zh:"你看见我的手机了吗？白色的。",py:"Nǐ kànjiàn wǒ de shǒujī le ma? Báisè de.",en:"Have you seen my phone? The white one."},{name:"A",zh:"别找了，手机在桌子上呢，电脑旁边。",py:"Bié zhǎo le, shǒujī zài zhuōzi shàng ne, diànnǎo pángbiān.",en:"Stop looking—the phone's on the table, next to the computer."},{name:"B",zh:"你看见我的衣服了吗？红色的那件。",py:"Nǐ kànjiàn wǒ de yīfu le ma? Hóngsè de nà jiàn.",en:"Have you seen my clothes? The red one."},{name:"A",zh:"那件衣服我帮你洗了，在外边呢。",py:"Nà jiàn yīfu wǒ bāng nǐ xǐ le, zài wàibian ne.",en:"I washed that one for you; it's outside."}],vocab:{seg:[{t:`A：你在找什么？
B：你看见我的`},{b:1},{t:`了吗？白色的。
A：别找了，手机在桌子上呢，电脑旁边。
B：你看见我的衣服了吗？红色的那件。
A：那件衣服我帮你`},{b:2},{t:"了，在外边呢。"}],answers:["手机","洗"]},grammar:{before:`A：你在找什么？
B：你看见我的手机了吗？白色的。
...
B：一个朋友。
A：什么朋友？是不是`},{b:2},{t:`？
B：不是不是，我同学介绍的，昨天第一次见。`}],answers:["唱歌","男朋友"]},grammar:{before:"A：王方，昨天",after:`人是谁？
B：一个朋友。
A：什么朋友？是不是男朋友？
...
B：是，`},{b:2},{t:`写字的那个人是我哥哥。
A：你哥哥多大？
B：25岁，他比我大三岁。`}],answers:["女孩子","右边"]},grammar:{before:`A：左边这个看报纸的女孩子是你姐姐吗？
B：是，右边写字的那个人是我哥哥。
A：你哥哥多大？
B：25岁，`,after:"。",answer:"他比我大三岁",tokens:["他","比","我","大","三岁"]},sentences:[{speaker:"A",text:"左边这个看报纸的女孩子是你姐姐吗？",tokens:["左边","这个","看","报纸","的","女孩子","是","你","姐姐","吗"]},{speaker:"B",text:"是，右边写字的那个人是我哥哥。",tokens:["是","右边","写","字","的","那个","人","是","我","哥哥"]},{speaker:"A",text:"你哥哥多大？",tokens:["你","哥哥","多大"]},{speaker:"B",text:"25岁，他比我大三岁。",tokens:["2","5","岁","他","比","我","大","三岁"]}],note:"动词短语做定语；“比”字句（1）；助动词“可能”"},{n:3,title:"课文3",original:`A：今天的西瓜怎么卖？
B：三块五一斤。
A：比昨天便宜。
B：是，苹果也比昨天便宜一些。您来点儿吧。`,lines:[{name:"A",zh:"今天的西瓜怎么卖？",py:"Jīntiān de xīguā zěnme mài?",en:"How much is the watermelon today?"},{name:"B",zh:"三块五一斤。",py:"Sān kuài wǔ yì jīn.",en:"Three-fifty a jin."},{name:"A",zh:"比昨天便宜。",py:"Bǐ zuótiān piányi.",en:"Cheaper than yesterday."},{name:"B",zh:"是，苹果也比昨天便宜一些。您来点儿吧。",py:"Shì, píngguǒ yě bǐ zuótiān piányi yìxiē. Nín lái diǎnr ba.",en:"Yes, the apples are a bit cheaper than yesterday too. Have some."}],vocab:{seg:[{t:`A：今天的西瓜怎么卖？
B：三块五一斤。
A：比昨天`},{b:1},{t:`。
B：是，苹果也比昨天便宜一些。您来点儿吧。`}],answers:["便宜"]},grammar:{before:`A：今天的西瓜怎么卖？
B：三块五一斤。
A：比昨天便宜。
...
B：是新来的汉语老师吗？
A：是`},{b:3},{t:"来的，她"},{b:4},{t:`王，28岁。
B：她比我们老师小两岁。`}],answers:["说话","可能","去年","姓"]},grammar:{before:"A：前边说话的那个人就是我的汉语老师。你",after:`。
B：是新来的汉语老师吗？
A：是去年来的，她姓王，28岁。
...
B：六点多。
A：你比我早起一个小时。
B：我睡`},{b:1},{t:"也早，我每天晚上十点就睡觉。早睡早起身体好。"}],answers:["得"]},grammar:{before:`A：你每天早上几点起床？
B：六点多。
A：你`,after:`。
...
B：不少了，今天吃得很好，太谢谢你了。
A：你做饭做得怎么样？
B：不怎么样，我`},{b:1},{t:"比我做得好。"}],answers:["妻子"]},grammar:{before:"A：再来点儿米饭吧，你",after:`。
B：不少了，今天吃得很好，太谢谢你了。
A：你做饭做得怎么样？
...
B：有`},{b:2},{t:"下10"},{b:3},{t:`吧？
A：是啊，你`},{b:4},{t:"得太少了，我们"},{b:5},{t:`房间吧。
B：好吧。`}],answers:["雪","零","度","穿","进"]},grammar:{before:`A：下雪了，今天真冷。
B：有零下10度吧？
A：是啊，你`,after:`，我们进房间吧。
B：好吧。`,answer:"穿得太少了",tokens:["穿","得","太少","了"]},sentences:[{speaker:"A",text:"下雪了，今天真冷。",tokens:["下","雪","了","今天","真","冷"]},{speaker:"B",text:"有零下10度吧？",tokens:["有","零下","1","0","度","吧"]},{speaker:"A",text:"是啊，你穿得太少了，我们进房间吧。",tokens:["是","啊","你","穿","得","太少","了","我们","进","房间","吧"]},{speaker:"B",text:"好吧。",tokens:["好","吧"]}],note:"程度补语；“比”字句（2）"},{n:4,title:"课文4",original:`A：你在忙什么呢？
B：我弟弟让我帮他找个房子，现在他家离公司有点儿远。
A：住得远真的很累！
B：是啊，他也希望能住得近一点儿。`,lines:[{name:"A",zh:"你在忙什么呢？",py:"Nǐ zài máng shénme ne?",en:"What are you busy with?"},{name:"B",zh:"我弟弟让我帮他找个房子，现在他家离公司有点儿远。",py:"Wǒ dìdi ràng wǒ bāng tā zhǎo ge fángzi, xiànzài tā jiā lí gōngsī yǒudiǎnr yuǎn.",en:"My younger brother asked me to help him find a place; his home is a bit far from the office now."},{name:"A",zh:"住得远真的很累！",py:"Zhù de yuǎn zhēn de hěn lèi!",en:"Living far away is really tiring!"},{name:"B",zh:"是啊，他也希望能住得近一点儿。",py:"Shì a, tā yě xīwàng néng zhù de jìn yìdiǎnr.",en:"Yeah, he also hopes to live a bit closer."}],vocab:{seg:[{t:`A：你在忙什么呢？
B：我`},{b:1},{t:`让我帮他找个房子，现在他家离公司有点儿远。
A：住得远真的很累！
B：是啊，他也希望能住得`},{b:2},{t:"一点儿。"}],answers:["弟弟","近"]},grammar:{before:`A：你在忙什么呢？
B：我弟弟让我帮他找个房子，现在他家离公司有点儿远。
A：住得远真的很累！
...
B：请问，张先生在吗？
A：他出去了。你下午再来吧。
B：好的，谢谢！`}],answers:["着"]},grammar:{before:"A：",after:`，请进。
B：请问，张先生在吗？
A：他出去了。你下午再来吧。
...
B：我知道她的名字，她姓杨，叫杨笑笑，她姐姐是我同学。
A：那个`},{b:1},{t:"里"},{b:2},{t:"着"},{b:3},{t:`的呢？
B：我不认识。`}],answers:["手","拿","铅笔"]},grammar:{before:`A：那个正在说话的女孩儿是谁？
B：我知道她的名字，她姓杨，叫杨笑笑，她姐姐是我同学。
A：那个`,after:`呢？
...
B：就是我们`},{b:1},{t:"那个"},{b:2},{t:"着两个大眼睛、非常爱"},{b:3},{t:`的女孩儿。
A：她不是有男朋友吗？
B：那个已经是她的前男友了。`}],answers:["班","长","笑"]},grammar:{before:`A：听说你有女朋友了？我认识她吗？
B：就是我们班那个长着两个大眼睛、非常爱笑的女孩儿。
A：`,after:`？
...
B：不远，走路二十分钟就到。
A：你能告诉我怎么走吗？
B：从这儿`},{b:2},{b:3},{t:"前走，到了前面的"},{b:4},{t:"再往右走。"}],answers:["宾馆","一直","往","路口"]},grammar:{before:`A：请问，这儿离新京宾馆远吗？
B：不远，走路二十分钟就到。
A：你能告诉我怎么走吗？
...
B：没看过，听说很`},{b:1},{t:`。
A：那我们下个星期一起去看吧？
B：可以，`},{b:2},{t:"我女朋友也想去。"}],answers:["有意思","但是"]},grammar:{before:"A：你",after:`那个电影没有？
B：没看过，听说很有意思。
A：那我们下个星期一起去看吧？
...
B：我`},{b:1},{t:"去过好几"},{b:2},{t:"，但是还想再去"},{b:3},{t:`玩儿。
A：那我们一起去吧。
B：好啊，到时候我给你打电话。`}],answers:["虽然","次","玩儿"]},grammar:{before:`A：听说你去过中国，还想去吗？
B：我`,after:`还想再去玩儿玩儿。
A：那我们一起去吧。
...
B：虽然是`},{b:1},{t:"天，"},{b:2},{t:`很冷。
A：那还能去跑步吗？
B：可以，但是你自己去吧，我还有很多事情要做。`}],answers:["晴","但是"]},grammar:{before:`A：明天天气怎么样？
B：`,after:`。
A：那还能去跑步吗？
...
B：买过一次，这儿的东西还可以，就是不便宜。
A：我喜欢这件衣服，`},{b:1},{t:`觉得有点儿贵。
B：两`},{b:2},{t:"块还可以，喜欢就买吧。"}],answers:["但是","百"]},grammar:{before:`A：你在这个商店买过东西没有？
...
B：你买票了吗？
A：还没有呢，明天就去火车站买票。`,lines:[{name:"A",zh:"今天是12月20日，新年就要到了。",py:"Jīntiān shì shí'èr yuè èrshí rì, xīnnián jiù yào dào le.",en:"Today is December 20th; the New Year is almost here."},{name:"B",zh:"新年你准备做什么？",py:"Xīnnián nǐ zhǔnbèi zuò shénme?",en:"What are you planning to do for New Year?"},{name:"A",zh:"我想去北京旅游，北京很不错，我去过一次。",py:"Wǒ xiǎng qù Běijīng lǚyóu, Běijīng hěn búcuò, wǒ qùguo yí cì.",en:"I want to travel to Beijing—Beijing is great; I've been once."},{name:"B",zh:"你买票了吗？",py:"Nǐ mǎi piào le ma?",en:"Have you bought your ticket?"},{name:"A",zh:"还没有呢，明天就去火车站买票。",py:"Hái méiyǒu ne, míngtiān jiù qù huǒchēzhàn mǎi piào.",en:"Not yet; I'll go buy it at the train station tomorrow."}],vocab:{seg:[{t:"A：今天是12月20日，"},{b:1},{t:`就要到了。
B：新年你准备做什么？
A：我想去北京旅游，北京很不错，我去过一次。
B：你买`},{b:2},{t:`了吗？
A：还没有呢，明天就去`},{b:3},{t:"买票。"}],answers:["新年","票","火车站"]},grammar:{before:"A：今天是12月20日，",after:`。
B：新年你准备做什么？
A：我想去北京旅游，北京很不错，我去过一次。
B：你买票了吗？
...
C：希望我们的公司明年`},{b:2},{t:"好！"}],answers:["大家","更"]},grammar:{before:"A：时间过得真快，",after:`！
B：是啊，谢谢大家这一年对我的帮助！
...
B：我们再等她几分钟吧。
A：都等她半个小时了！
B：她来了，我听见她说话了。`}],answers:["妹妹"]},grammar:{before:`A：你妹妹怎么还没来？都八点四十了！
B：我们再等她几分钟吧。
A：`,after:`！
...
B：好的，快要下雨了，你路上慢点儿。
A：没关系，我坐公共汽车。
B：好的。再见。`}],answers:["阴"]},grammar:{before:`A：天阴了，我要回去了。
B：好的，`,after:`，你路上慢点儿。
A：没关系，我坐公共汽车。
