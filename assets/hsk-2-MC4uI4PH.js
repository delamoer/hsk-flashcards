...
B：九月去北京旅游最好。
A：为什么？
B：九月的北京天气不冷`},{b:4},{t:"不热。"}],answers:["旅游","觉得","最","也"],tiles:{旅游:{py:"lǚyóu",en:"to travel; make a tour"},觉得:{py:"juéde",en:"to feel; think"},最:{py:"zuì",en:"most"},也:{py:"yě",en:"also; too"}}},grammar:{before:"A：我想去北京旅游，你觉得",after:`？
B：九月去北京旅游最好。
A：为什么？
...
B：我`},{b:2},{t:"喜欢"},{b:3},{t:`。
A：下午我们一起去踢足球吧。
B：好啊！`}],answers:["运动","最","踢足球"],tiles:{运动:{py:"yùndòng",en:"sport; to exercise"},最:{py:"zuì",en:"most"},踢足球:{py:"tī zúqiú",en:"to play football/soccer"}}},grammar:{before:`A：你喜欢什么运动？
B：我`,after:`喜欢踢足球。
A：下午我们一起去踢足球吧。
...
A：它`},{b:3},{t:`大了？
B：六个多月。`}],answers:["它","眼睛","多"],tiles:{它:{py:"tā",en:"it"},眼睛:{py:"yǎnjing",en:"eye; eyes"},多:{py:"duō",en:"many; much; how (with adjective)"}}},grammar:{before:`A：桌子下面有个猫。
B：那是我的猫，它叫花花。
A：它很漂亮。
B：是啊，我觉得它的眼睛最漂亮。
A：它多大了？
...
A：你每天几点`},{b:5},{t:`？
B：我每天六点起床。`}],answers:["生病","每天","早上","跑步","起床"],tiles:{生病:{py:"shēngbìng",en:"to get sick"},每天:{py:"měi tiān",en:"every day"},早上:{py:"zǎoshang",en:"morning"},跑步:{py:"pǎobù",en:"to run; jog"},起床:{py:"qǐchuáng",en:"to get up"}}},grammar:{before:"A：你很少生病，",after:`？
B：是啊，我每天早上都要出去跑步。
A：你每天几点起床？
...
B：一`},{b:2},{t:`八几。
A：你怎么`},{b:3},{t:`这么多啊？
B：他是我同学。`}],answers:["高","米","知道"],tiles:{高:{py:"gāo",en:"tall; high"},米:{py:"mǐ",en:"meter"},知道:{py:"zhīdào",en:"to know"}}},grammar:{before:"A：大卫今年",after:`？
B：二十多岁。
A：他多高？
B：一米八几。
A：你怎么知道这么多啊？
...
A：那会很累吧？
B：他每天回来都很累。`}],answers:["休息","忙","时间"],tiles:{休息:{py:"xiūxi",en:"to rest"},忙:{py:"máng",en:"busy"},时间:{py:"shíjiān",en:"time"}}},grammar:{before:`A：张老师星期六也不休息啊？
B：是啊，他这几天很忙，没有时间休息。
A：那会很累吧？
...
A：这件小的怎么样？
B：这件`},{b:4},{t:"，就买这件吧。"}],answers:["件","还","可以","不错"],tiles:{件:{py:"jiàn",en:"measure word for clothes/items"},还:{py:"huán",en:"to return; to give back"},可以:{py:"kěyǐ",en:"can; may"},不错:{py:"búcuò",en:"not bad; pretty good"}}},grammar:{before:`A：帮我看一下这件衣服怎么样？
B：颜色还可以，就是`,after:`。
A：这件小的怎么样？
...
B：开车也不快，路上车太多了！`}],answers:["离","公司","远","公共汽车","小时","慢"],tiles:{离:{py:"lí",en:"to be away from"},公司:{py:"gōngsī",en:"company"},远:{py:"yuǎn",en:"far away"},公共汽车:{py:"gōnggòng qìchē",en:"bus"},小时:{py:"xiǎoshí",en:"hour"},慢:{py:"màn",en:"slow"}}},grammar:{before:"A：",after:`？
B：很远，坐公共汽车要一个多小时呢！
A：坐公共汽车太慢了，你怎么不开车？
...
B：您住哪个房间？
A：317。
B：好的，我叫人去看看。`}],answers:["服务员"],tiles:{服务员:{py:"fúwùyuán",en:"waiter; waitress; attendant"}}},grammar:{before:`A：服务员，我房间的门打不开了。
B：您住哪个房间？
A：317。
...
B：看电视对学汉语有`},{b:2},{t:`。
A：明天的课你都准备好了吗？
B：都准备好了。`}],answers:["课","帮助"],tiles:{课:{py:"kè",en:"class; lesson"},帮助:{py:"bāngzhù",en:"to help; help"}}},grammar:{before:"A：",after:`，明天上午还有汉语课呢。
B：看电视对学汉语有帮助。
A：明天的课你都准备好了吗？
...
A：医生说吃药后两个小时不要喝茶。
B：医生还说什么了？
A：医生让你听我的。`}],answers:["别"],tiles:{别:{py:"bié",en:"don't; had better not"}}},grammar:{before:`A：别看报纸了，医生说你要多休息。
B：好，不看了。给我一杯茶吧。
A：医生说吃药后两个小时`,after:`。
B：医生还说什么了？
...
A：别找了，手机在桌子上呢，电脑旁边。
B：你看见我的衣服了吗？红色的那件。
A：那件衣服我帮你`},{b:2},{t:"了，在外边呢。"}],answers:["手机","洗"],tiles:{手机:{py:"shǒujī",en:"mobile phone"},洗:{py:"xǐ",en:"to wash"}}},grammar:{before:`A：你在找什么？
B：你看见我的手机了吗？白色的。
...
A：你哥哥多大？
B：25岁，他比我大三岁。`}],answers:["女孩子","右边"],tiles:{女孩子:{py:"nǚ háizi",en:"girl"},右边:{py:"yòubian",en:"right side"}}},grammar:{before:`A：左边这个看报纸的女孩子是你姐姐吗？
B：是，右边写字的那个人是我哥哥。
A：你哥哥多大？
...
B：好吧。`}],answers:["雪","零","度","穿","进"],tiles:{雪:{py:"xuě",en:"snow"},零:{py:"líng",en:"zero"},度:{py:"dù",en:"degree"},穿:{py:"chuān",en:"to wear"},进:{py:"jìn",en:"to enter; come in"}}},grammar:{before:`A：下雪了，今天真冷。
B：有零下10度吧？
A：是啊，你`,after:`，我们进房间吧。
...
A：我想去北京旅游，北京很不错，我去过一次。
B：你买`},{b:2},{t:`了吗？
A：还没有呢，明天就去`},{b:3},{t:"买票。"}],answers:["新年","票","火车站"],tiles:{新年:{py:"xīnnián",en:"New Year"},票:{py:"piào",en:"ticket"},火车站:{py:"huǒchēzhàn",en:"train station"}}},grammar:{before:"A：今天是12月20日，",after:`。
B：新年你准备做什么？
A：我想去北京旅游，北京很不错，我去过一次。
B：你买票了吗？
